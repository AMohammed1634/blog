...
(27, '2020_02_06_194450_create_product_colors_table', 14),
(28, '2020_02_06_200229_create_product_sizes_table', 15);
...
CREATE TABLE `product_colors` (
  ...
  `colorProduct` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `product_colors` (`id`, `Product_id`, `qty`, `colorCode`, `colorProduct`, `created_at`, `updated_at`) VALUES
(1, 1, 500, '#000000', '1.jpg', NULL, NULL),
(2, 1, 500, '#FFFFFF', '25-color.jpg', NULL, NULL),
(5, 1, 500, '#60b3f3', '14-color.jpg', NULL, NULL),
(7, 3, 500, '#5e889b', '2.jpg', NULL, NULL),
(8, 4, 500, '#58535a', '3.jpg', NULL, NULL),
(11, 3, 500, '#DDD', '11-color.jpg', NULL, NULL),
(12, 3, 500, '#F00', '12-color.jpg', NULL, NULL),
(13, 4, 500, '#1e1b2e', '18-color.jpg', NULL, NULL),
(14, 4, 500, '#252429', '15-color.jpg', NULL, NULL);
...
INSERT INTO `product_sizes` (`id`, `Product_color_id`, `size`, `qty`, `created_at`, `updated_at`) VALUES
(1, 1, 'Mediam', 500, NULL, NULL),
(2, 1, 'Large', 500, NULL, NULL),
(5, 1, 'X-Large', 500, NULL, NULL),
(6, 2, 'Mediam', 500, NULL, NULL),
(9, 2, 'Large', 500, NULL, NULL),
(10, 2, 'X-Large', 500, NULL, NULL);
...
(19, 'Ahmed', 4, 16, 1, '2020-02-06 07:33:56', '2020-02-06 07:33:56'),
(20, 'asd', 4, 30, 1, '2020-02-06 11:18:21', '2020-02-06 11:18:21');
...
(81, 1, -1, NULL, 16, 1, '2020-02-06 07:33:09', '2020-02-06 07:33:09'),
(82, 1, -1, NULL, 17, 1, '2020-02-06 07:33:32', '2020-02-06 07:33:32');
...
(13, 1, NULL, 'NewTextAdded0.543846261143415.jpg', NULL, NULL, NULL, '2020-02-06 06:58:26', '2020-02-06 06:58:26'),
(14, 1, NULL, 'NewTextAdded0.9201831869655767.jpg', NULL, NULL, NULL, '2020-02-06 07:01:05', '2020-02-06 07:01:05'),
(15, 1, NULL, 'NewTextAdded0.7801225343694947.jpg', NULL, NULL, NULL, '2020-02-06 07:38:58', '2020-02-06 07:38:58'),
(16, 1, NULL, 'NewTextAdded0.5014513279297067.jpg', NULL, NULL, NULL, '2020-02-06 10:13:11', '2020-02-06 10:13:11'),
(17, 1, NULL, 'NewTextAdded0.2491152087913565.jpg', NULL, NULL, NULL, '2020-02-06 11:21:29', '2020-02-06 11:21:29');
...
(1, 'Ahmed Mahrous Alex', 'AhmedMohammedMahrous@gmail.com', NULL, '$2y$10$z5S2hGWvIcSj31dOLfVRgO0F6/WsN29eehisI7N8VRmHYb1HQb8Me', 'rPMnr44AWQMPnLRQGgKjfFEnnsTGfsOFago9Kytjbd2mbhxk6G2YIiYYR1m3', '2019-08-08 14:36:53', '2020-02-06 07:34:41', 3, '! Fannan NewLook Sonic (1)_1580981681.jpg', '01129674856'),
...
(57, 1, 16, '! Fannan NewLook  Spidy (4)_1580846663.jpg', '2020-02-04 18:04:23', '2020-02-06 07:36:54', -1, -1, 166, 77),
(58, 10, 108, '! ! Fannan NewLook (9)_1580848952.jpg', '2020-02-04 18:42:32', '2020-02-04 18:42:59', -1, -1, 171, 82),
(59, 1, 84, '! ! Fannan NewLook (23)_1580979454.jpg', '2020-02-06 06:57:35', '2020-02-06 07:31:35', 83, 98, 228, 108),
(60, 1, 16, '! ! Fannan NewLook (2)_1580981825.jpg', '2020-02-06 07:37:05', '2020-02-06 07:39:10', -1, -1, 166, 77),
(61, 1, 103, '! ! Fannan NewLook (25)_1580991114.jpg', '2020-02-06 10:11:55', '2020-02-06 10:12:08', 140, 246, 166, 77),
(62, 1, 30, '! ! Fannan NewLook (21)_1580995204.jpg', '2020-02-06 11:20:04', '2020-02-06 11:22:20', 131, 242, 166, 77),
(63, 1, 30, '! ! Fannan NewLook (23)_1580995343.jpg', '2020-02-06 11:22:23', '2020-02-06 11:22:31', -1, -1, 166, 77);
...
--
ALTER TABLE `product_sizes`
  ADD CONSTRAINT `product_sizes_product_color_id_foreign` FOREIGN KEY (`Product_color_id`) REFERENCES `product_colors` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
