                        ...
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        <td>{{$order->id}}</td>
                                        <td><a href="{{route('invoice_print',[$order->users->id, $order->id])}}">{{$order->shopping_id}}</a></td>
