...
@section('body')
    ...
    <div class="container row justify-content-center" style="width: 70%;margin: auto">
        <div class="card">
            <h2 class="form-title" style="text-align: center">Update Product {{$product->name}}</h2>
            <br><br>
            <form action="{{route("products.save_update_product",[$product->id])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input id="" type="text" class="form-control @error('product_name') is-invalid @enderror"
                               name="product_name" value="{{ $product->name }}" required autocomplete="product_name" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <textarea id="" type="text" class="form-control @error('product_des') is-invalid @enderror"
                              name="product_des" value="{{ $product->description}}" required autocomplete="product_des" autofocus
                              style="height: 85px"
                    >
                        {{$product->description}}
                    </textarea>
                        ...
                        <select class="form-control" name="brand_id">
                            @foreach($brands as $brand)
                                ...
                                <option value="{{$brand->id}}"
                                        @if($brand->id == $product->category_id) selected @endif>{{$brand->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input id="" type="text" class="form-control @error('product_price') is-invalid @enderror"
                               name="product_price" value="{{ $product->price }}" required autocomplete="product_price" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <input id="" type="text" class="form-control @error('product_dis_price') is-invalid @enderror"
                               name="product_dis_price" value="{{ $product->discounted_price }}" required autocomplete="product_dis_price" autofocus>
